# YuGiOh_Card_Battle
A simplified version of the popular card game Yu-Gi-Oh, complete with chararcter selection, 5 pre-built decks (with descriptions about each), and different AI to battle against!

Here is the main class, the rest of the classes can be found in the file provided!
